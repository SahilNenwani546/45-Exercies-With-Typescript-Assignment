/* Task No: 34. Pizzas: Think of at least three kinds of your favorite pizza.
Store these pizza names in a array, and then use a for loop to print the name
of each pizza.
...
love pizza!*/
var pizza = ["pepperoni", "Chicken Tikka", "Vegetable"];
for (var pizzaName = 0; pizzaName < pizza.length; pizzaName++) {
    console.log("I like ".concat(pizza[pizzaName], " pizza"));
}
