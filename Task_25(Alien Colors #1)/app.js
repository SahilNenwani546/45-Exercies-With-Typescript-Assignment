/* Task No: 25. Alien Colors #1: Imagine an alien was just shot down in a game. Create a
...
var alien_Color = "Purple";
if (alien_Color === "Purple") {
    console.log("Alien Color is Black player just erned 5 points");
}
