/* Task No: 32.Checking Usernames: Do the following to create a program that 
...
let current_users : string [] = ["Ali", "Hamzah", "Adnan", "Tooba", "Muzammil"]

let new_users : string [] = ["Khalid", "Sahil", "Hamzah", "Mohit", "Adnan",]
