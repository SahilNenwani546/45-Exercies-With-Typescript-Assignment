/* Task # 06 :Stripping Names: Store a person’s name, and include some whitespace characters at
...
let Namewithwhitespce: string = "\n\t Sahil \t\n";
console.log(Namewithwhitespce);
let Namewithoutwhitespace = Namewithwhitespce.trim();
